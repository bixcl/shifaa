...
<?php
 ...
 $sql="select * from bookdetail WHERE civilID = :a";
 ...
 if($n>0){
    ...
    echo "<tr>";
        echo "<th scope='col'>Clinic Name</th>";
        echo "<th>Date</th>";
        echo "<th>Time</th>";
        echo "<th>action</th>";
    echo "</tr>";
        ...
        $_SESSION['iddi'] = $row['ID'];
        echo "</table>";
        echo "</div>";
    }
else
{
	echo "<p style='font-size: 30px;''>there is no appointment yet</p>";
