...
<body style=" background: url('https://images.pexels.com/photos/62693/pexels-photo-62693.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2') no-repeat; background-size: cover;">>
    <header class="header" >
        <a href="home2.php" class="logo">Shifaa.</a>
        <!--navigator bar-->
    ...
    <center>
        ...
        <button type="button" class="btn btn-light" style="font-size: 20px; color: #1eb8ba; width: 120px;"><a href="profile.php" style="color: #008486">profile</a></button>
        <button type="button" class="btn btn-light" style="font-size: 20px; color: #ffffff; background-color: #008486; margin-left: 20px; width: 120px;"><a href="book.php" style="color: #ffffff">book now</a></button>
    </center>
</body>
</html>
